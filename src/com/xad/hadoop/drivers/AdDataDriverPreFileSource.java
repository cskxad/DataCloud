...
/**
 * Driver to merge Ad Data before File based data source.
 */
public class AdDataDriverPreFileSource {

    public static void main(String[] args) throws Exception {
        if (args.length < 4) {
            System.err.println("Usage: AdDataDriverPreFileSource <input path> <input path 2> <input path 3> <output path> [jars]");
            System.exit(-1);
        }
