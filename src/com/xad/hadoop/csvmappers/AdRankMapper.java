 ...
 *
 */
public class AdRankMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        super.setup(context);
        System.out.println(context.getConfiguration().get("map.input.file"));
        System.out.println("Map file = " + Arrays.asList(context.getInputSplit().getLocations()));
        System.out.println("Map file = "+context.getConfiguration().get("map.input.file"));
...
//            System.out.println("Map File "+ Arrays.asList(context.getInputSplit().getLocations()));
            ...
            String[] adRankData = CsvUtils.csvLineAsArray(line, ",");
