...
/**
 * Mapper used to find top zipcode where searches are happening.
 * Would be great to have following aggregations
 * 1. Daily aggregation
 * 2. Hourly break-up
 */
public class TopZipCodeRequestMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
