...
/**
 * Vendor Demand mapper
 */
public class VendorDemandMapper extends Mapper<LongWritable, Text, Text, VendorStatsCounterWritable> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        try {
            ...
            context.write(new Text(keyword + DELIMITER + adVendor + DELIMITER + city + DELIMITER + state),
