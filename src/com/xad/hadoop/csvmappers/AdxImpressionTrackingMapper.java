 ...
 *
 */
public class AdxImpressionTrackingMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        try {
            ...
            adsData[AD_UNIQUE_ID_Idx] = impressionTrackingData[49];

            //Mukesh (2012-08-01 - Start)
            adsData[Ad_Key_Idx] = impressionTrackingData[50];
            adsData[Quality_Score_Idx] = impressionTrackingData[51];
            adsData[Bus_Location_Id_Idx] = impressionTrackingData[52];
            adsData[Creative_Id_Idx] = impressionTrackingData[53];
            adsData[Neptune_Bkt_Id_Idx] = impressionTrackingData[54];
            adsData[Group_Id_Idx] = impressionTrackingData[55];
            adsData[Campaign_Id_Idx] = impressionTrackingData[56];
            adsData[Ad_Unit_Id_Idx] = impressionTrackingData[57];
            //Mukesh (2012-08-01 - End)
